...
class Partner extends Model
{
    ...
    {
        $tableData = [];
        $tours = Tour::where('partner_id', $this->id)->where('status', 1)->get();
    ...
    {
        $tableData = [];
        $hotels = Hotel::where('partner_id', $this->id)->where('status', 1)->get();
    ...
    {
        $tableData = [];
        $restos = Resto::where('partner_id', $this->id)->where('status', 1)->get();
