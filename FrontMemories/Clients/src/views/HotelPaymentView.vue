      ...
      <div class="row">
        <div class="col-lg-8 add_bottom_15">
          ...
          <div id="policy">
            ...
            <router-link
              to="/hotel-booking-confirmation"
              class="btn_1 green medium"
          ...
          <div class="box_style_1">
            ...
            <table class="table table_summary">
              <tbody>
                <tr>
                  <td>Check in</td>
                  <td class="text-end">10 April 2015</td>
                </tr>
                <tr>
                  <td>Check out</td>
                  <td class="text-end">12 April 2015</td>
                </tr>
                <tr>
                  <td>Rooms</td>
                  <td class="text-end">1 double room</td>
                </tr>
                <tr>
                  <td>Nights</td>
            ...
            <router-link to="/hotel-booking-confirmation" class="btn_full"
              >Book now</router-link
            >
            <a class="btn_full_outline" href="single_hotel.html"
              ><i class="icon-right"></i> Modify your search</a
            >
          </div>
