          ...
          <div class="box_style_1">
            ...
            <table class="table table_summary">
              <tbody>
                ...
                <tr>
                  <td>Day</td>
                  <td class="text-end">25/10/2015</td>
                </tr>
                <tr>
                  <td>Time</td>
                  <td class="text-end">7.30pm</td>
                </tr>
              </tbody>
            </table>
            <router-link to="/resto-booking-confirmation" class="btn_full"
              >Book now</router-link
            >
            <a class="btn_full_outline" href="#"
              ><i class="icon-right"></i> Continue shopping</a
            >
          </div>
