          ...
          <div id="tools">
            <div class="row justify-content-between">
              ...
              <div class="col-md-6 col-sm-4 d-none d-sm-block text-end">
                <a href="all_tours_grid.html" class="bt_filters"
                  ><i class="icon-th"></i
                ></a>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="tour_list_desc">
                  ...
                  <p>
                    ...
                    vix, ad dicat sanctus detracto vis. Eos modus dolorum ex,
                    qui adipisci maiestatis inciderint no, eos in elit
                    dicat.....
                  </p>
                  <ul class="add_info">
                    <li>
                    ...
                    <li>
                      <div class="tooltip_styled tooltip-effect-4">
                        ...
                        <div class="tooltip-content">
                          <h4>Transport</h4>
                          <strong>Metro: </strong>Musée du Louvre station (line
                          1)
                          <br />
                          <strong>Bus:</strong> 21, 24, 27, 39, 48, 68, 69, 72,
                          81, 95
                          <br />
                        </div>
                      </div>
              ...
              <div class="col-lg-4 col-md-4 position-relative">
                ...
                <div class="img_list">
                  <a href="single_hotel.html">
                    ...
                    <div class="short_info">
                      <i class="icon_set_1_icon-6"></i>Hotel
                    </div>
                  </a>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-lg-4 col-md-4 position-relative">
                ...
                <div class="img_list">
                  ...
                  <div class="short_info">
                    <i class="icon_set_1_icon-26"></i>Transfer
                  </div>
                </div>
              </div>
              <div class="col-lg-6 col-md-6">
              ...
              <div class="col-lg-2 col-md-2">
                <div class="price_list">
                  <div>
                    ...
                    <p>
                      <a href="single_transfer.html" class="btn_1">Details</a>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.7s">
            <div class="row">
              <div class="col-lg-4 col-md-4 position-relative">
                ...
                <div class="img_list">
                  <a href="single_tour.html">
                    ...
                    <div class="short_info">
                      <i class="icon_set_1_icon-44"></i>Historic Building
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div class="col-lg-2 col-md-2">
                <div class="price_list">
                  <div>
                    <sup>$</sup>49*<span class="normal_price_list">$59</span
                    ><small>*Per person</small>
                    <p><a href="single_tour.html" class="btn_1">Details</a></p>
                  </div>
                </div>
