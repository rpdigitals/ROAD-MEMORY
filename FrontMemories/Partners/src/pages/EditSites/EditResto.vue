...
<template>
  <card class="card" title="Mise à jour du restaurant">
    <div>
      <form @submit.prevent="editResto">
          ...
          <form @submit="carForm = 1">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <select class="form-control" v-model="restoCategoryId">
                  <option
            ...
            <div
              ...
              v-if="restoEditedSuccessfully == 1"
            >
            ...
            <div
              ...
              style="font-size: 20px"
              v-if="restoEditedSuccessfully == 0"
            >
              <strong>
                Une erreur s'est produite. Vérifiez votre connexion et réessayez
              </strong>
              <strong>
                <button @click="initializeRestoEdition" class="btn">OK</button>
              </strong>
            </div>
        ...
        <div v-if="carForm == 1">
          ...
          >
            ...
            <strong>
              <button @click="resetRestoEdition" class="btn">OK</button>
            </strong>
          </div>
          <div class="text-center">
            <button
              ...
              @click="carForm == 0"
              class="btn-info"
              v-if="restoEditedSuccessfully == 2"
            >
              MODIFIER
            </button>
          </div>
...
<script src="../../script/edit-resto.js"></script>
<style scoped>
.day {
  display: block;
  padding-bottom: 7px;
